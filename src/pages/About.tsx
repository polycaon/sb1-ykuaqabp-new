...
function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">About Cost of MBA</h1>
      
      <div className="prose prose-blue max-w-none">
        <p className="text-lg text-gray-600 mb-8">
          Cost of MBA is your comprehensive guide to MBA programs worldwide. We help prospective students make informed decisions by providing transparent, up-to-date information about program costs, durations, and locations.
        </p>
